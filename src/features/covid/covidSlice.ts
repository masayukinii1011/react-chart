...
const initialState: covidState = {
  data: {
    ...
    lastUpdate: "2021-03-08T12:24:53.000Z",
  },
  country: "",
  dailyData: [
    {
...
//非同期関数はcreateSliceの外に作成。Action。
//createAsyncThunk(任意のActionType名, Payloadを返す関数)
...
export const covidSlice = createSlice({
  ...
  initialState,
  reducers: {},
  //extraReducers。createAsyncThunkで作成したActionをbuilder.addCaseで追加。
  //fulfilled。成功したら、stateの状態を変更するオブジェクトを返す。
  //pending。
  //rejected。
